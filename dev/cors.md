...
See the [CORS specifications](http://www.w3.org/TR/cors/) for more informations.

To use that extension, load OCamlfind package `ocsigenserver.ext.cors`, either from your Dune file (if you are using static linking), or from the configuration file:
