...
```
`set_remote_user r user` records the name of the user authenticated for this request (typically by [`Authbasic`](./Authbasic.md)). It is stored in the request cache and reported as the `%u` field of the access log.
