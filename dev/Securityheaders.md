...
If you want to use this extension with Ocsigen Server's configuration file, have a look at the [manual page](./securityheaders.md). If you are using Ocsigen Server as a library, use the interface described here.
