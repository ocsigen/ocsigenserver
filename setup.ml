...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0d36a29cc35af3fd5a9e9220e19fb1e2) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Object
                 ({
                   ...
                   {
                      obj_modules = ["Staticmod"];
                      obj_findlib_fullname =
                        Some ["ocsigenserver"; "ext"; "staticmod"]
                   });
               Executable
                 ({
                     cs_name = "ocsigenserver";
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "6\210X\000Hz\028\219\029\134\150\017\179\208\182\143";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
