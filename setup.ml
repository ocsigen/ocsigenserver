...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0c0eaeca0ed37bd830b8e8bed4e9db96) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\242\128\024\177\219v]5\0300\233\231C\161\182\143";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
