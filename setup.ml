...
(* OASIS_START *)
(* DO NOT EDIT (digest: 58848c0299666dcda1110ded9f311f5e) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build with CamlZip library";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build with Lwt Preemptive library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Parse command line";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Ocsipersist with SQLite";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Ocsipersist with DBM";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_containers = ["ocsigenserver"]
                   });
               Library
                 ({
                     cs_name = "commandline";
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "commandline", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/commandline/yes";
                      bs_compiled_object = Best;
                      bs_build_depends = [];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.ENot (OASISExpr.EFlag "commandline"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/commandline/no";
                      bs_compiled_object = Best;
                      bs_build_depends = [];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Object
                 ({
                   ...
                   {
                      obj_modules = ["Ocsigen_lib_base"];
                      obj_findlib_fullname =
                        Some ["ocsigenserver"; "baselib"; "base"]
                   });
               Library
                 ({
                     cs_name = "http";
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["Multipart"; "Http_lexer"; "Http_headers"; "Framepp"
                        ];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = ["ocsigenserver"]
               ...
               Object
                 ({
                   ...
                   {
                      obj_modules = ["Ocsigen_cookies"];
                      obj_findlib_fullname =
                        Some ["ocsigenserver"; "cookies"]
                   });
               Library
                 ({
                     cs_name = "server";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ocsipersist"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = ["ext"]
                   });
               Library
                 ({
                     cs_name = "ocsipersist-dbm";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "src/extensions/ocsipersist/ocsipersist-dbm";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "ocsigenserver";
                           FindlibPackage ("dbm", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/userconf";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsigenserver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/rewritemod";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsigenserver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/revproxy";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsigenserver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/redirectmod";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsigenserver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/outputfilter";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsigenserver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/ocsigen_comet";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "ocsigenserver";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/extensiontemplate";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsigenserver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/extendconfiguration";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsigenserver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/extensions/deflatemod";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "ocsigenserver";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/authbasic";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsigenserver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/accesscontrol";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsigenserver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/extensions/staticmod";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsigenserver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "server"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "_\003&\220\014r\003\204j\138\185\195\213\225\017\235";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
