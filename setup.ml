...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8fd94c666178b3fb20571acfc7f7b839) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("ipaddr", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "n\240\1294[a\128\130\155\167\213\002\211\245+'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
