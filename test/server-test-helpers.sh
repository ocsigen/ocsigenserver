...
# Start a prebuilt server binary (passed to the cram test as a dependency) and
# do the necessary setup. The server must listen on the unix-domain socket named
# "local.sock" and on the command-pipe named "local.cmd".
#
# Usage:
#   $ run_server ../my_server.exe
#   $ curl_ "index.html"
#
run_server ()
{
